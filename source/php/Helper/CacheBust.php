...
class CacheBust
{
    ...
    {
        $jsonPath = MODULARITY_NOTICEBOARD_PATH . apply_filters(
            'ModularityNoticeboard/Helper/CacheBust/RevManifestPath',
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . MODULARITY_NOTICEBOARD_PATH . ' and run gulp. See ' . MODULARITY_NOTICEBOARD_PATH . 'README.md for more info.</div>';
        }
    }
}
